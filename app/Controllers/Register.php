...
class Register extends Controller {
    ...
    public function process()
    {
        ...
        $users = new M_register();
            ...
            $this->actionVerifyGmail( $dataGuru['email'], $dataGuru['nama_lengkap'], $id_profile );
    ...
    function verifyAccount() {
        ...
        $id_profile = $this->request->getGet('id');
        ...
        return $model->model_prosesverifikasi( $id_profile, $data );
