...
<!--action> </thead> -->
                      <tbody>
                                  ...
                                  <?php foreach ( $dataSiswa->getResultArray() AS $siswa ) :  ?>
                                        ...
                                        <div class="modal fade" id="hapus-siswa-<?php echo $siswa['id_siswa'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                                    <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <h4>Hapus Guru</h4>
                                                        <p>Apakah anda yakin ingin mengahapus <?php echo $siswa['nama_lengkap'] ?> dari Data Siswa ? </p>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="/datasiswa/prosesHapusSiswa/<?php echo $siswa['id_siswa'] ?>" class="btn btn-danger">Hapus Sekarang</a>
                                                    </div>
                                ...
                                <div class="modal fade" id="hapus-siswa<?php echo $siswa['id_siswa'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="/datasiswa/prosesUpdateSiswa/<?php echo $siswa['id_siswa'] ?>" method="POST">
                                                <div class="modal-body">
                                  ...
                                  <tr>
                                    ...
                                    <td>  
                                        <a href=":;" class="btn btn-danger"  data-toggle="modal" data-target="#hapus-siswa-<?php echo $siswa['id_siswa'] ?>"><i class="material-icons">delete</i></a>
                                        <a href=":;" data-toggle="modal" data-target="#update-siswa-<?php echo $siswa['id_siswa'] ?>" class="btn btn-warning"><i class="material-icons">edit</i></a>
                                    </td>
