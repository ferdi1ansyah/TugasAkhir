								...
								<div class="d-flex align-items-center flex-wrap">
									...
									<a href="#" class="btn button-color btn-fixed-height font-weight-bold px-2 px-lg-5 mr-2">
										<span class="svg-icon svg-icon-lg">
											<!--begin::Svg Icon | path:<?php echo base_url() ?>/assets/metro/media/svg/icons/Communication/Add-user.svg-->
									...
									<div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
										<a href="#" class="btn btn-primary btn-fixed-height font-weight-bold px-2 px-lg-5 mr-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											<span class="svg-icon svg-icon-lg">
												<!--begin::Svg Icon | path:<?php echo base_url() ?>/assets/metro/media/svg/icons/Files/File.svg-->
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<polygon points="0 0 24 0 24 24 0 24" />
									...
									<a href="#" class="btn btn-primary btn-icon font-weight-bold" data-toggle="modal" data-target="#kt_chat_modal">
										<span class="svg-icon svg-icon-lg">
											<!--begin::Svg Icon | path:<?php echo base_url() ?>/assets/metro/media/svg/icons/Communication/Group-chat.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											...
											<form class="form" action="/datasiswa/prosesUbahSiswa/<?php echo $data_siswa['id_siswa'].'/'.$data_siswa['id_profile'] ?>" method="POST">
												<div class="card-body">
													<div class="form-group">
														...
														<input type="text" name="nama" value="<?php echo $data_siswa['nama_lengkap'] ?>" class="form-control" placeholder="Enter full name" />
													...
													<div class="form-group">
														...
														<input type="date" name="tanggal_lahir" value="<?php echo $data_siswa['tanggal_lahir'] ?>" class="form-control" placeholder="tanggal lahiranda" />
														<span class="form-text text-muted">masukan tanggal lahir anda</span>
													</div>

                                                    <div class="separator separator-dashed my-5"></div>
													<div class="form-group">
														<label>email</label>
														<input type="email" name="email" class="form-control" placeholder="Enter email" value="<?php echo $data_siswa['email'] ?>" />
													...
													<div class="form-group">
														<label>Telepon</label>
														<input type="text" name="telp" class="form-control" placeholder="Masukan Telp" value="<?php echo $data_siswa['telp'] ?>" />
														<span class="form-text text-muted">Asa pendidikan Tedrakhir</span>
													</div>
													...
													<div class="form-group">
														<label>Alamat</label>
														<input type="text" name="alamat" class="form-control" placeholder="Masukan Alamat" value="<?php echo $data_siswa['alamat'] ?>" />
													...
													<div class="form-group">
														...
														<input type="text" name="pendidikan_sekarang" class="form-control" placeholder="Pendidikan yang ditempuh sekarang" value="<?php echo $data_siswa['pendidikan_sekarang'] ?>" />
														<span class="form-text text-muted">pendidikan yang ditempuh sekarang</span>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" name="asal_sekolah" class="form-control" placeholder="Asal Sekolah" value="<?php echo $data_siswa['asal_sekolah'] ?>" />
														<span class="form-text text-muted">Asal Sekolah anda</span>
													</div>
                                                    ...
                                                    <input type="radio" id="aktif" name="status_akun" value="aktif" <?php if ( $data_siswa['status_akun'] == "aktif" ) { echo 'checked'; } ?>>

                                                    <label for="nonaktif">Nonaktif</label>
                                                    <input type="radio" id="nonaktif" name="status_akun" value="nonaktif" <?php if ( $data_siswa['status_akun'] == "nonaktif" ) { echo 'checked'; } ?>>
