											...
											<form class="form" action="/datasiswa/prosesTambahSiswa" method="POST">
												<div class="card-body">
													...
													<div class="form-group">
														...
														<input type="text" name="domisili" class="form-control" placeholder="domisili anda" />
													...
													<div class="form-group">
														...
														<input type="date" name="tanggal_lahir" class="form-control" placeholder="tanggal lahiranda" />
													...
													<div class="form-group">
														...
														<input type="text" name="pendidikan_sekarang" class="form-control" placeholder="Pendidikan yang ditempuh sekarang" />
