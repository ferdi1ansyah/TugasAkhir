											...
											<form class="form" action="/dataguru/prosesUbahGuru/<?php echo $data_guru['id_guru'].'/'.$data_guru['id_profile'] ?>" method="POST">
												<div class="card-body">
													...
													<div class="form-group">
														...
														<span class="form-text text-muted">Masukkan asal sekolah anda</span>
													</div>
													...
													<div class="form-group">
														...
														<span class="form-text text-muted">Pendidikan terakhir anda.....</span>
													</div>
													...
													<div class="form-group">
														...
														<span class="form-text text-muted">Masukan email anda</span>
													</div>
													...
													<div class="form-group">
														...
														<span class="form-text text-muted">Nomoer telepon anda ? </span>
													</div>
