        ...
        <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Tambah Materi Detail Baru</h3>
              </div>
            </div>
            <!-- End Page Header -->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-10">
                    ...
                    <form action="/datamateri/prosestambahdetail/<?php echo $id_materi ?>" method="POST" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="judul_materi" class="form-control" placeholder="Masukkan judul materi . . ." required="" >
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="customRadioInline1-1" name="tipe_materi" class="custom-control-input" value="visual_content">
                                                    <label class="custom-control-label" for="customRadioInline1-1">Gunakan Visual Konten</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="customRadioInline2-1" name="tipe_materi" class="custom-control-input" value="text_content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="customRadioInline1" name="status" class="custom-control-input" value="aktif">
                                                    <label class="custom-control-label" for="customRadioInline1">Publikasi</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="customRadioInline2" name="status" class="custom-control-input" value="nonaktif">
