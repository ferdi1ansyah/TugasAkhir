   ...
   <div class="main-content-container container-fluid px-12">
   	...
   	<div class="page-header row no-gutters py-4">
   		<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
   			<span class="text-uppercase page-subtitle">Menampilkan daftar kelas yang telah diikuti</span>
   			<h3 class="page-title">Kelas Saya</h3>
   		</div>
   	</div>
   	<!-- End Page Header -->
   	<div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-3" style="margin-bottom: 20px">
                <div class="stats-small stats-small--1 card card-small">
                    <a href="<?php echo base_url('dashboard/detail/'. $kolom['id_materi']) ?>">
                        <?php
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column m-auto">
                            <div class="stats-small__data">
                                ...
                                <div>
                                    <a href="/dashboard/course/<?php echo $kolom['id_materi'].'?page='. $kolom['index_materi'] ?>" class="btn"><i class="fas fa-list-ul"></i></a>
                                </div>
            ...
            <?php } else { ?>
				...
				<div class="col-md-12" style="text-align: center">
					...
					<?php echo svg() ?>
					<h4 style="margin: 0px">Kamu belum mengambil kelas</h4>
					<p>Ambil kelas sekarang dari materi para expertise</p>

					<a href="<?php echo base_url('dashboard/index3#course') ?>" class="btn btn-outline-primary">Lihat Kelas</a>
