            ...
            <div class="row align-items-center position-relative">
                ...
                <div class="col-lg-6">
                    <div class="hero-img wow fadeInUp" data-wow-delay=".5s">
                        <img src="<?php echo base_url() ?>/assets/saaspal/img/hero/hero-img2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-7">
                        <div class="section-title mb-15">
                            ...
                            <p class="text-white pr-5">Download Sumber Belajar materi materi yang saya dapatkan dari expert dan praktiksi</p>
                        </div>
                    </div>
