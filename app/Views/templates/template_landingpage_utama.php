...
<h1 class="wow fadeInUp" data-wow-delay=".4s">Belajar Bersama dan Sharing Bersama</h1>
...
<div class="col-xl-6 col-lg-6">
<div class="about-img">
<img src="<?php echo base_url() ?>/assets/saaspal/img/about/about-3" alt="" class="w-100">
<img src="<?php echo base_url() ?>/assets/saaspal/img/about/about-left-shape.svg" alt="" class="shape shape-1">
<img src="<?php echo base_url() ?>/assets/saaspal/img/about/left-dots.svg" alt="" class="shape shape-2">
</div>
</div>
...
<div class="about-content">
<div class="section-title mb-30">
<h1 class="mb-25 wow fadeInUp" data-wow-delay=".2s">Buat Konten Menarik untuk diajarkan</h1>
<p class="wow fadeInUp" data-wow-delay=".4s">buat konten yang menarik untuk diajarkan sebagai pemula.</p>
</div>
<a href="javascript:void(0)" class="main-btn btn-hover border-btn wow fadeInUp" data-wow-delay=".6s">Discover More</a>
</div>
</div>
...
<!-- // ====================================================================== -->
  ...
  <section id="daftar" class="pricing-section pt-120 pb-20">
    <div class="container">
    <div class="row justify-content-center">
    <div class="col-xxl-5 col-xl-6 col-lg-8 col-md-9">
    <div class="section-title text-center mb-35">
    <h1 class="mb-25 wow fadeInUp" data-wow-delay=".2s">Pilih Sebagai Guru atau Siswa</h1>
    <p class="wow fadeInUp" data-wow-delay=".4s">Pilih Sebgai guru maupun siswa untuk salin membantu sesama.</p>
    </div>
    </div>
    </div>
    ...
    <div class="content">
    <ul>
    <li> <i class="lni lni-checkmark active"></i> Buat Quiz</li>
    ...
    <div class="content">
    <ul>
    <li> <i class="lni lni-checkmark active"></i> Video Materi</li>
...
<h1 class="text-white mb-25">Ayo Daftar Sekarang</h1>
...
<script src="<?php echo base_url() ?>assets/saaspal/js/main.js"></script>
