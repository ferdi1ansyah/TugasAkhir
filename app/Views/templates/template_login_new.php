...
<html lang="en">
	...
	<body id="kt_body" class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-secondary-enabled page-loading">
				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="login-form login-signin">
							<!--begin::Form-->
							<form action="<?php echo base_url('login/proseslogin') ?>" class="form" novalidate="novalidate" id="" method="POST">
								<!--begin::Title-->
								...
								<div class="pb-lg-0 pb-5">
									<button type="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Log in</button>
						...
						<!----begin::Select Sebagai-->
						<div class="login-form login-signup">
							<!--begin::Form-->
							<form class="form" novalidate="novalidate" id="kt_login_signup_form">
								<!--begin::Title-->
								<div class="pb-13 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Pilihan Akun Sebagai</h3>
									<p class="text-muted font-weight-bold font-size-h4">Pilih akun mau mengajar maupun belajar</p>
								</div>
								<!--end::Title-->
								<!--begin::Form group-->
								<div class="form-group">

								<a id="kt_login_forgot" class="btn btn-outline-primary btn-lg btn-block"><i class="flaticon2-poll-symbol">Akun Pengajar</i></a>

								<button type="button" class="btn btn-outline-primary btn-lg btn-block"><i class="flaticon2-poll-symbol">Akun Siswa</i></button>
						...
						<div class="login-form login-forgot">
							...
							<form class="form" novalidate="novalidate" id="kt_login_forgot_form">
								...
								<!--begin::Form group-->
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6" type="usernaem" placeholder="Username" name="username" autocomplete="off" />
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
					...
					<div class="d-flex justify-content-lg-start justify-content-center align-items-end py-7 py-lg-0">
						<div class="text-dark-50 font-size-lg font-weight-bolder mr-10">
							...
							<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">Pipel.com</a>
						</div>
		...
		<script src="<?php echo base_url() ?>/assets/metro/js/pages/custom/login/login-general.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>